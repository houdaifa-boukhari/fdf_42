...
/*   Updated: 2024/05/03 14:17:23 by hel-bouk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	show_instructions(t_mlx *mlx)
{
	...
	mlx_string_put(mlx->mlx, mlx->mlx_win, 10, 90, 0xFF0000, "Rotation on x: 1, 2");
	mlx_string_put(mlx->mlx, mlx->mlx_win, 10, 110, 0xFF0000, "Rotation on y: 3, 4");
	mlx_string_put(mlx->mlx, mlx->mlx_win, 10, 130, 0xFF0000, "Rotation on z: 5, 6");
	mlx_string_put(mlx->mlx, mlx->mlx_win, 10, 150, 0xFF0000, "B: enable/disable bonus");
	mlx_string_put(mlx->mlx, mlx->mlx_win, 10, 170, 0xFF0000, "c: enable/disable random color");
}
